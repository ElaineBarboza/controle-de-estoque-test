...
describe('Dashboard principal', () => {
  ...
  it('Deve exibir o dashboard princial do sistema', () => {
    ...
    cy.xpath('/html/body/div/div/div/h4').should('contain', 'Dashboard de Estoque');

    cy.xpath('/html/body/div/div/div/p').should('contain', 'Bem-vindo ao sistema de controle de estoque.');
